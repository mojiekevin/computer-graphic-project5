...
public class ColorBoxesScreen extends GameScreen {

	GLBuffer vb, vbColor, ibTriangles, ibLines;
	...
	public void onEntry(GameTime gameTime) {
		...
		program.quickCreateResource("Grid", "cs4620/gl/GridVertexColor.vert", "cs4620/gl/GridVertexColor.frag", null);
		...
		vbColor = GLBuffer.createAsVertex(vertexColors, 3, BufferUsageHint.StaticDraw);
